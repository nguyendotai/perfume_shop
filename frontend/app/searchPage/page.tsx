          ...
          <div className="w-[80%]">
            <div className="flex justify-between items-center">
              <nav className="my-5">
                ...
                <a href="/store" className="font-bold">Cửa hàng</a>
              </nav>

              <div className="flex items-center space-x-6 text-gray-700 my-5">
                <div>
                  <span className="font-bold">Show :</span>
                  <a href="#" className="text-gray-500 hover:text-black">15</a>
                  <span className="mx-1">/</span>
                  <a href="#" className="text-gray-500 hover:text-black">25</a>
                  <span className="mx-1">/</span>
                  <a href="#" className="text-gray-500 hover:text-black">35</a>
                </div>
