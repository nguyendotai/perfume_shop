...
const Categories = () => {
  ...
  <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm space-y-4">
    <h3 className="text-lg font-semibold mb-4 text-gray-900">Danh sách danh mục</h3>
    <div className="overflow-x-auto">
      <table className="min-w-full text-sm text-left text-gray-800 border border-gray-200 bg-white rounded-lg overflow-hidden shadow-sm">
        ...
        <tbody>
          {categories.map((category, index) => (
            ...
            >
              ...
              <td className="py-3 px-4 text-gray-700">{category.ten_danh_muc}</td>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full p-2 rounded-lg bg-gray-100 border border-gray-300 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                required
              />
            </div>
            ...
            <div className="mb-4 flex items-center">
              <input
                ...
                className="w-4 h-4 border border-gray-300 rounded text-blue-500 focus:ring-blue-500"
              />
